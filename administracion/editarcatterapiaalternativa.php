...
<html>
    <head>
        ...
        <title>Editar | Categoria Terapia Alternativa</title> 
        <script type="text/javascript" language="JavaScript" >
    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARcomposicionquimica" action="recursos/acciones.php?tarea=60&id=<?php echo $_GET["id"]; ?>">
                    ...
                    <?php
                        $con=Conexion();
                        $sql_CATTERAPIA="select * from catterapia where idcatterapia='".$_GET["id"]."'";
