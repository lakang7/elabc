    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" enctype="multipart/form-data" id="form_CREARfambotanica" action="recursos/acciones.php?tarea=52&id=<?php echo $_GET["id"]; ?>">
			...
			$result_CONSEJO=mysql_query($sql_CONSEJO,$con) or die(mysql_error()); 
                        if(mysql_num_rows($result_CONSEJO)>0){
                    ...
                    <div class="col-md-12 contiene_entrada">
                        ...
                        <div class="col-md-12"><input type="text" class="form-control" value="<?php echo $consejo["titulo"]; ?>"  id="titulo" name="titulo" maxlength="60" required="required" /></div>
                    </div>                        
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Descripción del consejo</div>
                        <div class="col-md-12"><textarea maxlength="200" class="form-control" rows="3"  id="descripcion" name="descripcion" required="required"><?php echo $consejo["descripcion"]; ?></textarea></div>
                    </div> 
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Imagen para el Consejo [Tamaño recomendado 350x250px]</div>
                        <div class="col-md-12"><input class="form-control" name="imagenConsejo" type="file" /></div>
                    </div>                                                
                    <div class="col-md-12 contiene_entrada">
