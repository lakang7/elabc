...
<html>
    <head>
        ...
        <title>Editar | Familia Botánica</title> 
        <script type="text/javascript" language="JavaScript" >
    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARcomposicionquimica" action="recursos/acciones.php?tarea=5&id=<?php echo $_GET["id"]; ?>">
                    ...
                    <?php
                        $con=Conexion();
                        $sql_FAMBOT="select * from fambotanica where idfambotanica='".$_GET["id"]."'";
			$result_FAMBOT=mysql_query($sql_FAMBOT,$con) or die(mysql_error()); 
                        if(mysql_num_rows($result_FAMBOT)>0){
                            $fila = mysql_fetch_assoc($result_FAMBOT);                                                            
                        }                    
                    ?>
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Nombre de la Familia Botánica</div>
                    ...
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Descripción de la Familia Botánica</div>
