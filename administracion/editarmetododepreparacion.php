...
<html>
    <head>
        ...
        <title>Editar | Metodo de Preparacion</title>
        <script type="text/javascript" language="JavaScript" >
    ...
    <body>
        <div class="container">
			...
			$result_TERAPIA=mysql_query($sql_TERAPIA,$con) or die(mysql_error()); 
                    ...
                    ?>                     
                    <form method="post" enctype="multipart/form-data" id="form_CREARcomposicionquimica" action="recursos/acciones.php?tarea=69&id=<?php echo $_GET["id"]; ?>">
                        <div class="col-md-12 titulopagina" style="margin-top: 125px;">Metodo de Preparacion</div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Nombre del Metodo de Preparacion</div>
                    ...
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Nombre para mostrar del Metodo de Preparacion</div>
                    ...
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Categorias para el Metodo de preparacion</div>
                        <div class="col-md-12">
                        <select id="categoria" name="categoria" class="selectpicker show-tick" data-live-search="true" data-width="100%" required="required">
                            <?php
                                $con=Conexion();
                                $sql_listaFAMBOT="select * from catmetodo order by nombre";
                                ...
                                if(mysql_num_rows($result_listaFAMBOT)>0){
                                    while ($fila = mysql_fetch_assoc($result_listaFAMBOT)) {
                                        if($terapia["idcatterapia"]==$fila["idcatterapia"]){
                                            echo "<option selected='selected' value='".$fila["idcatmetodo"]."'>".$fila["nombre"]."</option>";
                                        }  else {
                                            echo "<option value='".$fila["idcatmetodo"]."'>".$fila["nombre"]."</option>";
                                        }
