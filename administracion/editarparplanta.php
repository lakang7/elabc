...
<html>
    <head>
        ...
        <title>Editar | Partes de la Planta</title> 
        <script type="text/javascript" language="JavaScript" >
    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARcomposicionquimica" action="recursos/acciones.php?tarea=8&id=<?php echo $_GET["id"]; ?>">
                    ...
                    <?php
                        $con=Conexion();
                        $sql_PARPLA="select * from parplanta where idparplanta='".$_GET["id"]."'";
			$result_PARPLA=mysql_query($sql_PARPLA,$con) or die(mysql_error()); 
                        if(mysql_num_rows($result_PARPLA)>0){
                            $fila = mysql_fetch_assoc($result_PARPLA);                                                            
                        }                    
                    ?>
