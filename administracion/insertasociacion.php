...
<html>
    <head>
        ...
        <title>Insertar | Asociación</title>
        <script type="text/javascript" language="JavaScript" >
    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARfambotanica" action="recursos/acciones.php?tarea=34">
                    ...
                    <div class="col-md-12 contiene_entrada">
                        ...
                        <div class="col-md-12"><textarea maxlength="2000" class="form-control" rows="3"  id="descripcion" name="descripcion" required="required"></textarea></div>
                    </div> 
                    <div class="col-md-12 contiene_entrada">
