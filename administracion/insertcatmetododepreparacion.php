...
<html>
    <head>
        ...
        <title>Insertar | Categoria Metodo de Preparacion</title>
        <script type="text/javascript" language="JavaScript" >
    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARfambotanica" action="recursos/acciones.php?tarea=65">
                    ...
                    <div class="col-md-12 contiene_entrada">
                        <div class="col-md-12 titulo_entrada">Nombre de la Categoria del Metodo de Preparacion</div>
