...
<div id="fb-root"></div>        
        <div class="container">
            <div class="row" style="margin-bottom: 15px;">
                ...
                <!--<div class="col-md-9" style="text-align: right; font-family: 'Open Sans Condensed', sans-serif; font-size: 14px; margin-bottom: 10px">La Grita, 18 de Agosto de 2015</div>-->
                <div class="col-md-9">
                    <div class="row">
